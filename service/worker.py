...
from service.acquisition.jobs import acquire_album, acquire_album_from_mb, acquire_track, backfill_replaygain, compute_album_replaygain, enrich_track, fetch_missing_covers, fetch_missing_lyrics, fix_all_album_tags, gc_staging  # noqa: E402


class WorkerSettings:
    redis_settings = RedisSettings.from_dsn(settings.redis_url)
    functions = [acquire_track, acquire_album, acquire_album_from_mb, enrich_track, gc_staging, fetch_missing_covers, fetch_missing_lyrics, fix_all_album_tags, compute_album_replaygain, backfill_replaygain, worker_heartbeat, auto_rescan]
    cron_jobs = [
